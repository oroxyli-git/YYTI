...
export const PERSONALITY_TYPES = [
    ...
    },
    {
        ...
        description: '你是一个目标明确心怀众生的人。就像鹏长老一样，你做事雷厉风行、果断决绝，从不拖泥带水，也总是能看到这个世界更本质也更结构性的问题，然后毅然决然"我想要、我造路、我实现"。你相信终有一日定能实现天下大同，而你会为了实现自己心中的蓝图探索所有的可能、倾注所有的心血。',
        note: '系统备注：你是那种事情必须完成否则浑身不得劲的人。请问你是机器人吗？',
    ...
    },
    {
        ...
        description: '你是那种自己已经很苦了，却还忍不住帮助别人的人。就像龟奶奶一样，明明自己承受了很多，但每当看到比自己更弱小的人，你总是第一个伸出手。你的善良正是因为你太清楚苦难的滋味，所以不忍心让别人也尝到。"跟大侠走咯，过好日子去了"，这些寄托在别人身上的美好希望会实现的。',
        note: '系统备注：你是那种自己吃泡面也要给流浪猫买罐头的人。世界需要你。',
    ...
    },
    {
        ...
        note: '系统备注：你是那种团建时第一个举杯、最后一个离场的领导。在你的团队一定欢声笑语吧。',
    ...
    },
    {
        ...
        description: '你是那种被世界伤透了、却还没有彻底放弃世界的人。就像盈盈一样，从饱受欺凌的底层一路爬到权力的顶端，为此不惜舍弃人性、戴上冷酷的面具。你可能做过很多"不得不做"的事，双手并不干净，但你的内心深处始终有一盏灯没有熄灭。当温暖再次触碰到你的时候，你会发现——原来那个叫"盈盈"的自己，从未真正消失。你不会再让任何人受苦，因为你比谁都清楚，被抛弃和被珍惜各是什么滋味。',
    ...
    },
    {
        ...
        description: '你是那种把别人的苦难当成自己责任的人。就像沈义伦一样，身为常平使，你最大的心愿不是升官发财，而是"愿天下人不知饥馑"。你善良到近乎固执，答应过的事哪怕赴汤蹈火也要做到。你会因为自己的一个过错而后悔很久很久，反复自责"如果当时我做了不同的选择"。你不求名垂青史，只求问心无愧。你是乱世中最稀缺的存在——一个真正为苍生也为亲朋而活的人。',
    ...
    },
    {
        ...
        note: '系统备注：你的人生轨迹就是"我本将心向明月，奈何明月照沟渠"的完美诠释。这一次，但愿你也来得及拯救自己。',
